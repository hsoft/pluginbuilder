...
py2plugin options, to be specified in the options keyword to the setup function:
...
__version__ = pkg_resources.require('py2plugin')[0].version

# This makes the py2plugin command work in the distutils.core.setup() case
import setuptools
